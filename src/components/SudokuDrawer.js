...
function SudokuDrawer() {
  ...
  const dialogSaveAs = React.useCallback(
    () => dispatch(DialogSaveAs()),
    [dispatch]
  )
  ...
  return (
    ...
    >
      <List>
        ...
        <ListItem button className={classes.drawerItem} onClick={dialogOpen}>
          <ListItemIcon><FolderOpenIcon /></ListItemIcon>
          <ListItemText primary={drawerLabels.open + '...'} />
        </ListItem>
        <ListItem button className={classes.drawerItem} onClick={dialogSaveAs}>
